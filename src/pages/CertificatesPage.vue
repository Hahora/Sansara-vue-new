  ...
  <div class="min-h-screen bg-[#edeae6] pb-20">
    ...
    <div class="bg-[#202c27] text-white px-5 py-6">
      <div class="flex items-center justify-between mb-4">
        ...
        <div class="relative">
          <button
            @click.stop="showBranchSelect = !showBranchSelect"
          ...
          >
            ...
            <span class="text-white font-medium text-[13px] max-w-[90px] truncate">
            ...
            <div v-if="showBranchSelect" class="absolute right-0 top-full mt-2 w-64 bg-white/95 backdrop-blur-xl rounded-xl shadow-2xl border border-gray-200/50 z-50 max-h-72 overflow-y-auto">
              <div class="py-2">
                ...
                <div class="space-y-0.5">
                  <div
                    v-for="branch in allBranches" :key="branch.id"
                    @click="handleSelectBranch(branch)"
                    class="px-4 py-2.5 mx-2 rounded-lg hover:bg-gray-50 cursor-pointer transition-all"
                    :class="{ 'bg-[#c2a886]/10 border-l-2 border-[#c2a886]': selectedBranch?.id === branch.id }"
                  >
                    <div class="flex items-center gap-2.5">
                      <div class="h-7 w-7 rounded-full bg-[#202c27]/5 flex items-center justify-center flex-shrink-0">
                        <MapPin class="h-3 w-3 text-[#202c27]" />
                      </div>
