    ...
    >
      ...
      >
        <div class="flex items-center justify-between">
          <h3 class="font-bold text-base">Создать промокод</h3>
  ...
  methods: {
    ...
    async createPromo() {
      try {
        ...
        console.log("Создание промокода:", this.formData);
        ...
        const response = await promoAPI.create(dataToSend);

        console.log("Промокод создан:", response);
